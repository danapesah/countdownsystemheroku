...
onSubmit(e) {
  ...
  //send the use data to the backend, send HTTP POST REQUEST to this 'http://https://countdownsystem.herokuapp.com//users/add', backend endpoint 
  //that expects a jason object in the request body and we send it as a second arguement
  axios.post('http://https://countdownsystem.herokuapp.com/users/add', user)
